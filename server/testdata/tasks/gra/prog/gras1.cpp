/* Rozwiazanie wolne do zadania MAF (Mafia)
 * Autor: Jakub Radoszewski
 * Data: 05.05.2007
 * Opis: Dla kazdej slabo spojnej skladowej probujemy wszystkie
 * permutacje jej wierzcholkow jako kolejnosc strzelania i... strzelamy.
 */
