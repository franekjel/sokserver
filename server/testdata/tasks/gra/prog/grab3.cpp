/* Rozwiazanie bledne do zadania MAF (Mafia)
 * Autor: Jakub Radoszewski
 * Data: 14.05.2007
 * Opis: Rozwiazanie o zlozonosci czasowej O(n), oparte na tym samym
 * pomysle co maf2.cpp, ale strzelanie na cyklu zaczyna od losowego
 * jego punktu.
 */
